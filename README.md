...
- The script is a temporary solution to allow mass wallet creation and get the numbers going. We have plans to create a more robust and permanent solution.
